...
import { getSecureRandomNumber } from "@/utils/password";
...
function SidebarMenuItem({ className, ...props }: React.ComponentProps<"li">) {
  return (
    <li
      ...
      className={cn(
        "group/menu-item relative transition-normal group-data-[collapsible=icon]:mx-auto",
        className
      )}
      {...props}
    />
...
function SidebarMenuSkeleton({
  ...
  const width = React.useMemo(() => {
    return `${getSecureRandomNumber(40) + 50}%`;
  }, []);
