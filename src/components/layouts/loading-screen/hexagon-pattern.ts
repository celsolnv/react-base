// SVG string para uso como background-image pattern
export const HEXAGON_SVG_STRING = `
...
// Converte SVG para data URL otimizado
...
// Data URL pré-calculado para performance
export const HEXAGON_PATTERN_URL = svgToDataUrl(HEXAGON_SVG_STRING);
